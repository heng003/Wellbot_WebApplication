                ...
                html: (
                    <div style={{ textAlign: 'left', marginTop: '0.5em' }}>
                        ...
                        <ul>
                            ...
                            <li>Authorized Admins with your Well-Bot ID can view emotional trends.</li>
                            <li>No other parties will have access.</li>
                        </ul>

                        <h4 className='mt-4'>Admin Access Authorization</h4>
                        <p>Do you consent to allow Admin users with your Well-Bot ID to view your emotional state history for caregiving or therapeutic support?</p>
                        <br />
