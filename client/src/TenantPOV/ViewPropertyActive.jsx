    ...
    <div>
      <main>
        <section id="PropertyImage">
          <div className="container">
            <div className="imageContainer">
              <img
                src={propertyImageSrc[currentIndex]}
                alt="propertyImages"
                className="propertyImage"
              />
              <img
                src={
                  propertyImageSrc[(currentIndex + 1) % propertyImageSrc.length]
                }
                alt="propertyImages"
                className="propertyImage"
                id="propertyImage2"
        ...
        <div className="PropertyStatus">
          <PropertyStatus
            text="CURRENTLY ACTIVELY LEASED"
            backgroundColor="#238613"
            textColor="#FFFFFF"
          />
        </div>
...
export default ViewPropertyActive;
