...
function LandlordHistory() {
  ...
  const tenants = [
    {
      id: "Lye23356",
      date: "7 January 2024 - 7 January 2025",
      status: "Effective",
    },
    {
      id: "Sioskso45",
      date: "6 December 2022 - 6 December 2023",
      status: "Expired",
    },
    {
      id: "MuhammadAli",
      date: "31 December 2020 - 2 December 2021",
      status: "Expired",
    },
  ];
  ...
  const tenants2 = [
    {
      id: "Idharib78",
      date: "7 December 2024 - 7 December s2025",
      status: "Effective",
    },
  ];

  const handleDownloadIconMouseEnter = (index) =>
    setHoveredDownloadIcon((prev) => ({ ...prev, [index]: true }));
  const handleDownloadIconMouseLeave = (index) =>
    setHoveredDownloadIcon((prev) => ({ ...prev, [index]: false }));
  const handleCommentIconMouseEnter = (index) =>
    setHoveredCommentIcon((prev) => ({ ...prev, [index]: true }));
  const handleCommentIconMouseLeave = (index) =>
    setHoveredCommentIcon((prev) => ({ ...prev, [index]: false }));

  const handleDownloadIconMouseEnter2 = (index) =>
    setHoveredDownloadIcon2((prev) => ({ ...prev, [index]: true }));
  const handleDownloadIconMouseLeave2 = (index) =>
    setHoveredDownloadIcon2((prev) => ({ ...prev, [index]: false }));
  const handleCommentIconMouseEnter2 = (index) =>
    setHoveredCommentIcon2((prev) => ({ ...prev, [index]: true }));
  const handleCommentIconMouseLeave2 = (index) =>
    setHoveredCommentIcon2((prev) => ({ ...prev, [index]: false }));
        ...
        {data.map((tenant, index) => (
          <tr key={tenant.id}>
            ...
            <td>
              <img
                src={
                  downloadIconState[index] ? DownloadHoverIcon : downloadIcon
                }
      ...
      return (
        <>
          ...
          {renderTable(
            ...
            handleCommentIconMouseEnter,
            handleCommentIconMouseLeave
          )}
          <h2 className="propertyName">{properties[1]}</h2>
          {renderTable(
            tenants2,
            hoveredDownloadIcon2,
            hoveredCommentIcon2,
            handleDownloadIconMouseEnter2,
            handleDownloadIconMouseLeave2,
            handleCommentIconMouseEnter2,
            handleCommentIconMouseLeave2
          )}
        </>
      );
    } else {
