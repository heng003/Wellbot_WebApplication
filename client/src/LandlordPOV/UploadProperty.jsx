        ...
        <div className="image-row">
         ...
         <div className="editLandlordForm">
                ...
                <div className="row" id="row2">
                    ...
                    <div class="col">
                        <h6>Address</h6>
                        <input type="text" name="editAddress" id="editAddress" placeholder="Eg :Jalan Perdana 2/8, Pandan Perdana, 55300 Kuala Lumput" onChange={handleChange}/>
                    </div>
                    {/* <div className="displayErrorMessage">
            ...
            <div className="editLandlordForm">
                ...
                <div className="row">
                    <div className="col">
                        ...
                        <option value="" disabled hidden>Please Select Type of Furnishing</option>
                ...
                <div className="row">
                    <div className="col">
                        ...
                        <option value="" disabled hidden>Please Select Number of Floor</option>
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                        </select>
                    ...
                    <div class="col">
                        <h6>Build-up Size</h6>
                        <input type="text" name="editSize" id="editSize" placeholder="---- sqft" required pattern="[0-9]}"/>
                    </div>
                </div>
                ...
                <div className="row">
                    <div class="col">
                        <h6>Facilities</h6>
                        <input type="text" name="editFac" id="editFac" placeholder="Eg : Security 24 Hr, Swimming, Elevator, Gym, Dobby, Playground, Mart" required/>
                    </div>
                    <div class="col">
                        <h6>Accesibility</h6>
                        <input type="text" name="editAccesibility" id="editAccesibility" placeholder="Eg : Seventeenmall - 600m , MRT Tiara Damansara - 1km " required/>
                    </div>
                </div>
