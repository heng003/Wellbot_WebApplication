  ...
  useEffect(() => {
    async function fetchLeases() {
      try {
        ...
        const relevantLeases = response.data.filter(
          (lease) =>
      ...
      <div className="rental-history">
        ...
        <div className="commentForm">
          <h5 className="commenth5">
            ...
            tenant. Feel free to share your feedback with them based on the
            aspects below.
          </h5>
