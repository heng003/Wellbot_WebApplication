        ...
        <div className="image-row">
         ...
         <div className="editLandlordForm">
                ...
                <div className="row" id="row2">
                    <div class="col">
                        <h6>Property Name</h6>
                        <input type="text" name="editPropertyName" id="editPropertyName" placeholder="Enter Property Name" required/>
                    </div>
                    <div class="col">
                        <h6>Address</h6>
                        <input type="text" name="editAddress" id="editAddress" placeholder="Enter Property's Address" required/>
                    </div>
                </div>
