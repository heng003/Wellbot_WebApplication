    ...
    <div>
      <main>
            ...
            <div className="row" id="landlordMain">
              <div className="col">
                <div className="container" id="homeTitle">
                  <div className="row">
                    <p className="display-4 fw-bolder mt-5">
                      Find Your Uploaded Property
                      <span id="text"> In Just A Moment</span>
                    </p>
                  </div>
                  <div className="row" id="filter_location">
                    ...
                    <div className="col" id="filter_residential">
                      ...
                      >
                        <div className="displayed-value">
                          {selectedOption1 || "All Residential"}
                        </div>
                        {isPropertyTypeOpen && (
                  ...
                  <div className="col" id="searchFilter">
                    ...
                    <input
                      ...
                      name="searchProperty"
                      id="searchProperty"
                      placeholder="Search By Your Property Name"
                    />
                  </div>
                  <br></br>
        ...
        <section id="recommendation">
          ...
          >
            {(isSearchClicked ? filteredProperties : cardData).map(
              (card, index) => (
              ...
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title1">
                    Upload Your Property Details <span id="hoverText">Now</span>
                  </h4>
